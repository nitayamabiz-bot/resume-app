...
<div class="page-content">
    ...
    <div class="page-text">
        当サイトへの広告掲載をご希望の方は、以下のフォームにご記入ください。費用、期間などは要相談です。
        <span class="page-text-nepali">
            यस साइटमा विज्ञापन प्रकाशन चाहनुहुन्छ भने, तलको फारम भर्नुहोस्। खर्च, अवधि आदिको लागि परामर्श आवश्यक छ।
        </span>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('advertisement.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="service_name" class="form-input" value="{{ old('service_name') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="representative_name" class="form-input" value="{{ old('representative_name') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" name="site_url" class="form-input" value="{{ old('site_url') }}" placeholder="https://example.com" required>
            </div>
