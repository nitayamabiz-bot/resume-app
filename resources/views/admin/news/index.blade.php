                        ...
                        <tr>
                            ...
                            <td class="border p-3">
                                <div class="flex gap-2">
                                    <a href="{{ route('admin.news.edit', $item) }}" class="px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600">
                                        編集 / सम्पादन
                                    </a>
                                    <form action="{{ route('admin.news.destroy', $item) }}" method="POST" onsubmit="return confirm('削除してもよろしいですか？ / के तपाईं मेटाउन चाहनुहुन्छ?');">
                                        @csrf
                                        @method('DELETE')
