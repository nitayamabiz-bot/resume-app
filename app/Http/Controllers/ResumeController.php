...
class ResumeController extends Controller
{
    ...
    public function download(Request $request)
    {
        try {
            ...
            try {
                ...
                \Log::error('Failed to save resume submission: '.$e->getMessage());
                // 保存に失敗してもPDF生成は続行
            }
    ...
    public function generateMotivation(Request $request)
    {
        ...
        $prompt .= "11. 生成するテキストには、志望動機の本文のみを出力してください。文字数や【文字数】などの余計な情報、説明、コメントは一切含めないでください。純粋に志望動機の本文のみを返してください。\n\n";
        ...
        $prompt .= '【重要】出力は志望動機の本文のみです。文字数、【文字数】、説明、コメント、メタ情報などは一切含めず、純粋に志望動機の本文だけを返してください。';
