...
<?php $component = App\View\Components\GuestLayout::resolve(['title' => '新規登録 / दर्ता - 就労支援サービス'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <!-- 戻るボタン -->
    <div class="mb-4">
        <a href="<?php echo e(url()->previous() !== url()->current() ? url()->previous() : route('home')); ?>" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
...
<?php endif; ?>
        ...
        <div class="mt-4">
            <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'password_confirmation']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\diggy\Desktop\hamro-life-japan.com\resources\views/auth/register.blade.php ENDPATH**/ ?>