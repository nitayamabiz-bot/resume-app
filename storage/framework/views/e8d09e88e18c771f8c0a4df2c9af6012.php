        ...
        <div class="header-content">
            <div class="nav-links">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="nav-link">マイページ<span class="block text-xs" style="font-family: 'Noto Sans Devanagari', Arial, sans-serif;">मेरो पृष्ठ</span></a>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="nav-link">ログイン<span class="block text-xs" style="font-family: 'Noto Sans Devanagari', Arial, sans-serif;">लगइन</span></a>
                    <a href="<?php echo e(route('register')); ?>" class="nav-link-btn">新規登録<span class="block text-xs" style="font-size: 0.7rem; opacity: 0.9;">दर्ता</span></a>
                <?php endif; ?>
            </div>
...
<?php /**PATH /Users/ni/Desktop/resume-app/resources/views/layouts/main.blade.php ENDPATH**/ ?>