...
<body>
    <header class="header">
        ...
        <div class="nav-links">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-link" style="display: inline-block; text-decoration: none; cursor: pointer; pointer-events: auto;">ログイン <span class="inline-text" style="font-family: 'Noto Sans Devanagari', Arial, sans-serif;">/ लगइन</span></a>
                <a href="<?php echo e(route('register')); ?>" class="nav-link-btn" style="display: inline-block; text-decoration: none; cursor: pointer; pointer-events: auto;">新規登録 <span class="inline-text" style="font-size: 0.7rem; opacity: 0.9;">/ दर्ता</span></a>
            <?php endif; ?>
        </div>
    </header>
    <!-- スマホ表示時の認証ボタンブロック -->
...
<?php /**PATH C:\Users\diggy\Desktop\hamro-life-japan.com\resources\views/layouts/main.blade.php ENDPATH**/ ?>