...
<head>
    ...
    <style>
        ...
        * {
        ...
        @font-face {
            font-family: 'ipaexg';
            src: url('<?php echo e(storage_path("app/fonts/ipaexg.ttf")); ?>') format('truetype');
            font-weight: normal;
            font-style: normal;
        }
        body {
...
<body>
    ...
    <div class="resume-page">
        <table>
            ...
            <tr>
                ...
                <td colspan="2" class="date-cell"><?php echo e(date('Y')); ?>年<?php echo e(date('n')); ?>月<?php echo e(date('j')); ?>日現在</td>
            </tr>
            
            <!-- ふりがな・氏名・写真行（5列構成） -->
            <tr style="height: 14mm;">
                <td class="header-label">ふりがな</td>
                <td class="name-kana-cell"><?php echo e($resumeData['name_kana'] ?? ''); ?></td>
                <td class="header-label">氏名</td>
                <td class="name-cell"><?php echo e($resumeData['name_roman'] ?? ''); ?></td>
            ...
            <tr style="height: 14mm;">
                ...
                <td colspan="2" class="birthday-cell">
                    <?php if(!empty($resumeData['birthday'])): ?>
                        <?php
                            $date = \Carbon\Carbon::parse($resumeData['birthday']);
                        ?>
                        <?php echo e($date->format('Y')); ?>年<?php echo e($date->format('n')); ?>月<?php echo e($date->format('j')); ?>日生（満<?php echo e($date->age); ?>歳）
                    <?php endif; ?>
                </td>
                <td class="header-label">※性別</td>
                <td class="gender-cell"><?php echo e($resumeData['gender'] ?? ''); ?></td>
            </tr>
            ...
            <tr style="height: 14mm;">
                ...
                <td colspan="2" class="phone-cell"><?php echo e($resumeData['phone'] ?? ''); ?></td>
            </tr>
            ...
            <tr style="height: 14mm;">
                ...
                <td class="address-cell">〒<?php echo e($resumeData['postal_code'] ?? ''); ?> <?php echo e($resumeData['address'] ?? ''); ?></td>
            </tr>
            ...
            <?php $__currentLoopData = $firstPageHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="history-row">
                <td class="year-cell"><?php echo e($history['year']); ?></td>
                <td class="month-cell"><?php echo e($history['month']); ?></td>
                <td colspan="3" class="content-cell"><?php echo e($history['content']); ?></td>
            </tr>
    ...
    <div class="resume-page">
        <table>
            ...
            <?php $__currentLoopData = $remainingHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="history-row">
                <td class="year-cell"><?php echo e($history['year']); ?></td>
                <td class="month-cell"><?php echo e($history['month']); ?></td>
                <td colspan="3" class="content-cell"><?php echo e($history['content']); ?></td>
            ...
            <?php $__currentLoopData = $licenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($license['date']) && !empty($license['name'])): ?>
                    <?php
                        $licenseDate = \Carbon\Carbon::parse($license['date']);
                        $licenseCount++;
                    ?>
                    <tr class="history-row">
                        <td class="year-cell"><?php echo e($licenseDate->year); ?></td>
                        <td class="month-cell"><?php echo e($licenseDate->month); ?></td>
                        <td colspan="3" class="content-cell"><?php echo e($license['name'] ?? ''); ?>　取得</td>
                    </tr>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            
            <?php for($i = $licenseCount; $i < 7; $i++): ?>
            <tr class="empty-cell">
                <td class="year-cell"></td>
                <td class="month-cell"></td>
                <td colspan="3" class="content-cell"></td>
            ...
            <tr>
                <td colspan="5" class="appeal-cell"><?php echo e($resumeData['appeal_points'] ?? ''); ?></td>
            </tr>
            ...
            <tr>
                <td colspan="5" class="request-cell"><?php echo e($resumeData['self_request'] ?? ''); ?></td>
            </tr>
        </table>
    </div>
</body>
</html>
<?php /**PATH /Users/ni/Desktop/hamro-life-japan.com/resources/views/resume/pdf.blade.php ENDPATH**/ ?>